...
#AUTHOR : KEFO
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO KEFO
...
def main():
	...
	print("\033[96;1m  [J] JOIN KEFO GROUP \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Kefo82/Kefo77.git")
			os.system("rm -rf Kefo.py")
			os.system("cp -f Kefo/Kefo.py \\.")
			os.system("rm -rf Kefo")
